 ...
 */
    ...
    function refreshVOI(){  
        ...
        var MakeTable = document.getElementById("MakeTable");
        //var tableRows = MakeTable.getElementsByTagName('tr');   
        var rowCount = MakeTable.rows.length;
alert("get talbe");
        for (var r = 1; r < rowCount; r++) {
            MakeTable.deleteRow(-1);
         }
...
//                  var cell2 = row.insertCell(1);
                  ...
                  cell1.innerHTML = rois.getElementsByTagName("make")[i].childNodes[0].nodeValue;
